...
namespace eLibrary
{
    public class Program
    {
        public static void Main (string[] args)
        {
            ...
            builder.Services.AddDbContext<ELibraryContext>(opt => opt.UseSqlServer("Server=.; Database=DaatabaseHome14; Integrated Security = true; TrustServerCertificate=Yes"));
            DbContextOptionsBuilder optionsBuilder = new DbContextOptionsBuilder();
            optionsBuilder.UseSqlServer("Server=.; Database=DaatabaseHome14; Integrated Security = true; TrustServerCertificate=Yes");
