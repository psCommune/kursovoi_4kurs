...
namespace kursovoi_4kurs
{
    public class Program
    {
        public static void Main (string[] args)
        {
            ...
            builder.Services.AddDbContext<kursovoi_4kursContext>(opt => opt.UseSqlServer("Server=.; Database=DaatabaseHome18; Integrated Security = true; TrustServerCertificate=Yes"));
            DbContextOptionsBuilder optionsBuilder = new DbContextOptionsBuilder();
            optionsBuilder.UseSqlServer("Server=.; Database=DaatabaseHome18; Integrated Security = true; TrustServerCertificate=Yes");
